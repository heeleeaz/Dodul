...
class OnboardingPageController: NSPageController, NSPageControllerDelegate {
    override func viewDidLoad() {
        ...
        self.delegate = self
        self.arrangedObjects = [OnboardingModel(imageUri: "", description: "Easily drag your apps and web pages to the Touchbar"),
                                OnboardingModel(imageUri: "", description: "")]
    ...
    func pageController(_ pageController: NSPageController, viewControllerForIdentifier identifier: NSPageController.ObjectIdentifier) -> NSViewController {
        guard
            ...
            let model = arrangedObjects[index] as? OnboardingModel else{ return NSViewController() }
