...
extension String {
    ...
    // Strip tags
    var tagsStripped: String {return self.deleteTagByPattern(Regex.rawTagPattern)}
    ...
    func isImage() -> Bool {return Regex.test(self, regex: Regex.imagePattern)}
    
    func isVideo() -> Bool {return Regex.test(self, regex: Regex.videoTagPattern)}
